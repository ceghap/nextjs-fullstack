      ...
      <nav className="border-b border-gray-200 bg-white px-4 py-2.5 dark:bg-gray-800 lg:px-6">
        <div className="flex flex-wrap items-center justify-between">
          ...
          <div className="flex items-center lg:order-2">
            ...
            >
              <div className="block bg-gray-50 py-2 px-4 text-center text-base font-medium text-gray-700 dark:bg-gray-700 dark:text-gray-400">
                Notifications
              </div>
              <div>
                <a
                ...
                >
                  <div className="flex-shrink-0">
                    ...
                    />
                    <div className="bg-primary-700 absolute ml-6 -mt-5 flex h-5 w-5 items-center justify-center rounded-full border border-white dark:border-gray-700">
                      <svg
                        aria-hidden="true"
                ...
                >
                  <div className="flex-shrink-0">
                    ...
                    />
                    <div className="absolute ml-6 -mt-5 flex h-5 w-5 items-center justify-center rounded-full border border-white bg-gray-900 dark:border-gray-700">
                      <svg
                        aria-hidden="true"
                        className="h-3 w-3 text-white"
                        fill="currentColor"
                ...
                >
                  <div className="flex-shrink-0">
                    ...
                    />
                    <div className="absolute ml-6 -mt-5 flex h-5 w-5 items-center justify-center rounded-full border border-white bg-red-600 dark:border-gray-700">
                      <svg
                        aria-hidden="true"
                        className="h-3 w-3 text-white"
                        fill="currentColor"
                ...
                >
                  <div className="flex-shrink-0">
                    ...
                    />
                    <div className="absolute ml-6 -mt-5 flex h-5 w-5 items-center justify-center rounded-full border border-white bg-green-400 dark:border-gray-700">
                      <svg
                        aria-hidden="true"
                        className="h-3 w-3 text-white"
                        fill="currentColor"
                ...
                >
                  <div className="flex-shrink-0">
                    <img
                      ...
                      alt="Robert image"
                    />
                    <div className="absolute ml-6 -mt-5 flex h-5 w-5 items-center justify-center rounded-full border border-white bg-purple-500 dark:border-gray-700">
                      <svg
                        aria-hidden="true"
                        className="h-3 w-3 text-white"
                        fill="currentColor"
            ...
            >
              ...
              >
                ...
                <li>
                  <a
                    href="#"
                    className="flex items-center justify-between py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                  >
